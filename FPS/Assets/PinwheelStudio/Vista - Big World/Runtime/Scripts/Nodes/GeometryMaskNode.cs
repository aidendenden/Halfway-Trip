...
namespace Pinwheel.Vista.Graph
{
    ...
    public class GeometryMaskNode : ImageNodeBase
    {
        ...
        private static readonly string KW_HEIGHT_MASK = "HEIGHT_MASK";
        private static readonly string KW_SLOPE_MASK = "SLOPE_MASK";
        private static readonly string KW_DIRECTION_MASK = "DIRECTION_MASK";
        private static readonly string KW_BLEND_MAX = "BLEND_MAX";
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            {
                m_material.EnableKeyword(KW_BLEND_MAX);
            }
            else
            {
                m_material.DisableKeyword(KW_BLEND_MAX);
            }
            ...
            if (m_enableHeightMask)
            {
                ...
                m_material.EnableKeyword(KW_HEIGHT_MASK);
            }
            else
            {
                m_material.DisableKeyword(KW_HEIGHT_MASK);
            }
            ...
            if (m_enableSlopeMask)
            {
                ...
                m_material.EnableKeyword(KW_SLOPE_MASK);
            }
            else
            {
                m_material.DisableKeyword(KW_SLOPE_MASK);
            }
            ...
            if (m_enableDirectionMask)
            {
                ...
                m_material.EnableKeyword(KW_DIRECTION_MASK);
            }
            else
            {
                m_material.DisableKeyword(KW_DIRECTION_MASK);
            }
