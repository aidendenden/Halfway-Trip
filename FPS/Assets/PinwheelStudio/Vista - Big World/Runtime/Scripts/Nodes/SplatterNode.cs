    ...
    public class SplatterNode : ImageNodeBase
    {
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            if (maskTexture != null)
            {
                ...
                m_material.EnableKeyword(KW_HAS_MASK_MAP);
            }
            else
            {
                m_material.DisableKeyword(KW_HAS_MASK_MAP);
            }
            ...
            if (intensityTexture != null)
            {
                ...
                m_material.EnableKeyword(KW_HAS_INTENSITY_BUFFER);
            }
            else
            {
                m_material.DisableKeyword(KW_HAS_INTENSITY_BUFFER);
            }
