...
namespace Pinwheel.PolarisMiniEditor
{
    public static partial class EditorCommon
    {
        ...
        {
            string prefKey = EditorCommon.GetProjectRelatedEditorPrefsKey("foldout", prefkeys);
        ...
        public static Rect BeginGroup()
        {
            ...
            GUI.Box(EditorCommon.boxOffset.Add(r), "");
            return r;
        }
        ...
        {
            string prefKey = EditorCommon.GetProjectRelatedEditorPrefsKey("foldout", id);
        ...
        {
            EditorGUI.DrawRect(r, EditorCommon.assetPreviewGrey);
            ...
            else
            {
                ...
                {
                    EditorGUI.LabelField(r, "Loading preview...", EditorCommon.CenteredWhiteLabel);
                }
                else
                {
                    EditorGUI.LabelField(r, "Preview not available!", EditorCommon.CenteredWhiteLabel);
                }
            }
        }
        ...
        public static RenderPipelineType GetCurrentRP()
        {
            ...
            {
                return RenderPipelineType.Other;
            }
        }
    }
}
