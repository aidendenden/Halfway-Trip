...
{
    public struct GeometryJobUtilities
    {
        ...
        public static Color GetColorBilinear(TextureNativeDataDescriptor<Color32> tex, Vector2 uv)
        {
            return GetColorBilinear(tex, ref uv);
        }
        public static float GetFloatBilinear(TextureNativeDataDescriptor<float> tex, Vector2 uv)
        {
            return GetFloatBilinear(tex, ref uv);
        }

        public static float GetFloatBilinear(TextureNativeDataDescriptor<float> tex, ref Vector2 uv)
        {
            ...
            float f00 = tex.data[To1DIndex(ref xFloor, ref yFloor, ref tex.width)];
            float f01 = tex.data[To1DIndex(ref xFloor, ref yCeil, ref tex.width)];
            float f10 = tex.data[To1DIndex(ref xCeil, ref yFloor, ref tex.width)];
            float f11 = tex.data[To1DIndex(ref xCeil, ref yCeil, ref tex.width)];
        ...
        public static Color GetColorBilinear(TextureNativeDataDescriptor<Color32> tex, ref Vector2 uv)
        {
            Vector2 pixelCoord = new Vector2(
                Mathf.Lerp(0, tex.width - 1, uv.x),
                Mathf.Lerp(0, tex.height - 1, uv.y));
        ...
        public static Color GetColorPoint(TextureNativeDataDescriptor<Color32> tex, Vector2 uv)
        {
            Vector2 pixelCoord = new Vector2(
                Mathf.Lerp(0, tex.width - 1, uv.x),
                Mathf.Lerp(0, tex.height - 1, uv.y));
        ...
        public static float GetFloatPoint(TextureNativeDataDescriptor<float> tex, Vector2 uv)
        {
            Vector2 pixelCoord = new Vector2(
                Mathf.Lerp(0, tex.width - 1, uv.x),
                Mathf.Lerp(0, tex.height - 1, uv.y));
        ...
        public static void MarkVertex(ref NativeArray<bool> markerArray, ref Vector2 p)
        {
            ...
            markerArray[GeometryJobUtilities.To1DIndex(ref x, ref y, ref dimension)] = true;
        }

        public static void MarkVertices(ref NativeArray<bool> markerArray, ref SubdivNode n)
        {
        ...
        public static bool GetVertexMark(NativeArray<bool> markers, Vector2 p, bool flipX = false, bool flipY = false)
        {
            ...
            return markers[GeometryJobUtilities.To1DIndex(ref x, ref y, ref dimension)];
        }
