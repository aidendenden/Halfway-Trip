...
namespace Pinwheel.Vista.Graph
{
    ...
    public class PointGridNode : ExecutableNodeBase
    {
        ...
        private ComputeShader SetupComputeShader(GraphContext context, out int gridDimension)
        {
            ...
            if (m_relativeTo == RelativeTo.Per100Meters)
            {
                gridBounds.z = Mathf.Ceil(biomeBounds.z / 100f) * 100f;
                gridBounds.w = Mathf.Ceil(biomeBounds.w / 100f) * 100f;
                gridDimension = (int)(gridBounds.z / 100) * m_density;
            }
